...
DATA_CONNECTION_OBJS = $(DATA_CONNECTION:$(SRC_DIR)/%.cpp=$(OBJ_DIR)/%.o)
MAIN_OBJS = $(MAIN_SRCS:$(SRC_DIR)/%.cpp=$(OBJ_DIR)/%.o)

# All objects
OBJS = $(CLIENT_OBJS) $(SERVER_OBJS) $(SOCKET_OBJS) $(DATA_CONNECTION) $(MAIN_OBJS)
...
$(NAME): $(OBJS)
	$(CC) $(CFLAGS) $(CLIENT_OBJS) $(SOCKET_OBJS) $(DATA_CONNECTION) $(OBJ_DIR)/main_client.o -o client
	$(CC) $(CFLAGS) $(SERVER_OBJS) $(SOCKET_OBJS) $(DATA_CONNECTION) $(OBJ_DIR)/main_server.o -o server
